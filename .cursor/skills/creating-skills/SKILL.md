...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user asks to create a new skill or defining a new capability.
---

# Gemini Skill Creator

## When to use this skill
- When the user asks to "create a skill" or "add a new capability".
- When you need to standardize the creation of a working directory for a specific task type.

## Workflow
- [ ] Understand the user's goal for the new skill.
- [ ] Determine the skill name (gerund form).
- [ ] Create the folder structure: `.agent/skills/<skill-name>/`
- [ ] Create `SKILL.md` with:
    - [ ] YAML Frontmatter (name, description).
    - [ ] Sections: When to use, Workflow, Instructions, Resources.
- [ ] (Optional) Create `scripts/`, `examples/`, `resources/`.
